  ...
  return (
    <section className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-3xl flex-col items-center justify-center px-4 py-12 text-center">
      <div className="rounded-2xl border bg-card/70 p-8 shadow-sm backdrop-blur-sm sm:p-10">
        ...
        <p className="text-xs font-semibold tracking-[0.16em] text-muted-foreground">GROUP NOT FOUND</p>
        <h1 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">Group not available</h1>
        <p className="mt-3 max-w-md text-sm text-muted-foreground sm:text-base">
          We could not find a group with that slug.
        </p>
