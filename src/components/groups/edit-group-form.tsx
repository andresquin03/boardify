...
export function EditGroupForm({
  ...
  const formKey = `${groupId}|${initialValues.name}|${initialValues.description}|${initialValues.icon}|${initialValues.color}|${initialValues.visibility}`;
